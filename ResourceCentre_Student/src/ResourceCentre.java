...
public class ResourceCentre {
	...
	public static void addChromebook(ArrayList<Chromebook> chromebookList, Chromebook cb) { // (TODO) (Task 2) ** (Checked complete) 
		// write your code here
		Chromebook item;
		for(int i = 0; i < chromebookList.size(); i++) {
